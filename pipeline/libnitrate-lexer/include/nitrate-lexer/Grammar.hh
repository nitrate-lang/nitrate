...
namespace ncc::lex {
  ...
  inline static const auto LEXICAL_KEYWORDS = detail::MakeBimap<std::string, Keyword>({
      ...
      {"struct", Struct},   {"region", Region},
      {"group", Group},     {"class", Class},
      {"union", Union},     {"opaque", Opaque},
      {"enum", Enum},       {"__fstring", __FString},
      {"fn", Fn},           {"unsafe", Unsafe},
      {"safe", Safe},       {"promise", Promise},
      {"if", If},           {"else", Else},
      {"for", For},         {"while", While},
      {"do", Do},           {"switch", Switch},
      {"break", Break},     {"continue", Continue},
      {"ret", Return},      {"retif", Retif},
      {"foreach", Foreach}, {"try", Try},
      {"catch", Catch},     {"throw", Throw},
      {"async", Async},     {"await", Await},
      {"__asm__", __Asm__}, {"undef", Undef},
      {"null", Null},       {"true", True},
      {"false", False},     {"escape_block", EscapeBlock},
  });
