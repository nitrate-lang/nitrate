...
// CPP_EXPORT void ir::nr_diag_read(IRModule *nr, nr_report_cb cb,
//                                  uintptr_t data) {
//   // if (!cb) {
//   //   return;
//   // }
...
//     auto data = format_overview(issue_info.left.at(R.code).overview,
//     R.param); auto lines = word_break(data, WIDTH);

//     if (lines.size() == 0) {
//     } else if (lines.size() == 1) {
//       ss << ind << "\x1b[33m╠\x1b[0m \x1b[35;1m" << lines[0] <<
//       "\x1b[0m\n\n";
//     } else {
//       ss << ind << "\x1b[33m╔\x1b[0m \x1b[35;1m" << lines[0] << "\x1b[0m\n";
//       for (size_t i = 1; i < lines.size() - 1; i++) {
//         ss << ind << "\x1b[33m║\x1b[0m \x1b[35;1m" << lines[i] <<
//         "\x1b[0m\n";
//       }
...
//         if (lines.size() == 0) {
//         } else if (lines.size() == 1) {
//           ss << ind << "\x1b[33m╠═\x1b[0m \x1b[37m" << lines[0] <<
//           "\x1b[0m\n";
//         } else {
//           ss << ind << "\x1b[33m╠═\x1b[0m \x1b[37m" << lines[0] <<
//           "\x1b[0m\n"; for (size_t i = 1; i < lines.size() - 1; i++) {
...
//                << "\x1b[0m\n";
//           }
//           ss << ind << "\x1b[33m║\x1b[0m   \x1b[37m" << lines[lines.size() -
//           1]
//              << "\x1b[0m\n";
//         }
//       }
