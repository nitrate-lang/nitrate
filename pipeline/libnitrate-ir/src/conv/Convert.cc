...
//       args[0] = {"_0", arg};
//       R = b.createCall(ir::create<ir::Ident>(save("std::ceil"), nullptr),
//       args);
...
//   if (!target.has_value()) {
//     G->report(ir::CompilerError, IC::Error, "Failed to lower function
//     target",
//               n->get_pos());
//     return std::nullopt;
//   }
...
//   if (!key.has_value()) {
//     G->report(ir::CompilerError, IC::Error, "Failed to lower associative
//     key",
//               n->get_pos());
//     return std::nullopt;
//   }
...
//   if (!stmt.has_value()) {
//     G->report(CompilerError, IC::Error, "Failed to lower statement
//     expression",
//               n->get_pos());
//     return std::nullopt;
//   }
...
//   if (!ret.has_value()) {
//     G->report(CompilerError, IC::Error, "Failed to lower function return
//     type",
//               n->get_pos());
//     return std::nullopt;
//   }
...
//     if (!val.has_value()) {
//       G->report(ir::CompilerError, IC::Error, "Failed to lower struct
//       method",
//                 n->get_pos());
//       s.ns_prefix = old_ns;
//       return std::nullopt;
...
//     G->report(
//         CompilerError, IC::Error,
//         {"The requested ABI name '", n->get_abi_name(), "' is not
//         supported"}, n->get_pos());
//     return std::nullopt;
//   }
