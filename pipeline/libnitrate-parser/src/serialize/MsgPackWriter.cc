...
void AST_MsgPackWriter::uint_impl(uint64_t val) {
  /// TODO: Implement support for JSON
  qcore_implement();
}
...
void AST_MsgPackWriter::bool_impl(bool val) {
  /// TODO: Implement support for JSON
  qcore_implement();
}

void AST_MsgPackWriter::null_impl() {
  /// TODO: Implement support for JSON
  qcore_implement();
}

void AST_MsgPackWriter::begin_obj_impl() {
  /// TODO: Implement support for JSON
  qcore_implement();
}
...
void AST_MsgPackWriter::begin_arr_impl(size_t max_size) {
  /// TODO: Implement support for JSON
  qcore_implement();
}
