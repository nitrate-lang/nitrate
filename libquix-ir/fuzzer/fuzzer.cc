...
extern "C" int LLVMFuzzerInitialize(int *argc, char **argv) {
  ...
  std::cout << "+===========================================================+\n";
  std::cout << "Initialized libquix-lexer, libquix-prep, libquix-parser, and libquix-ir\n";
  std::cout << "VERSIONS:\n";
  ...
  std::cout << "  - libquix-ir: " << qxir_lib_version() << std::endl;
...
extern "C" int LLVMFuzzerFinalize() {
  ...
  std::cout << "Deinitialized libquix-lexer, libquix-parser, and libquix-ir" << std::endl;
  return 0;
}
