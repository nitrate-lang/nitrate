...
TEST_CASE(Stmt_ReturnIf, Expr, 0, R"( retif 10, 20; )",
          block{safety : None statements{return_if{condition{integer{number : "10"}} value{integer{number : "20"}}}}});
TEST_CASE(Stmt_ReturnIf, Expr, 1, R"( retif 1+1, 2+2; )", block{safety:None statements{return_if{condition{binary{operator:Op_Plusleft{integer{number:"1"}}right{integer{number:"1"}}}}value{binary{operator:Op_Plusleft{integer{number:"2"}}right{integer{number:"2"}}}}}}});
