...
TEST_CASE(Keyword, Parse, 38, "retif", {Retif})
...
TEST_CASE(Keyword, Parse, 46, "undef", {Undef})
TEST_CASE(Keyword, Parse, 47, "null", {Null})
...
TEST_CASE(Keyword, NextToInt, 37, "'abc'retif'hello'", {Token(Text, "abc"), Retif, Token(Text, "hello")})
...
TEST_CASE(Keyword, NextToInt, 45, "'abc'undef'hello'", {Token(Text, "abc"), Undef, Token(Text, "hello")})
TEST_CASE(Keyword, NextToInt, 46, "'abc'null'hello'", {Token(Text, "abc"), Null, Token(Text, "hello")})
...
TEST_CASE(Keyword, NextToPunc, 37, "+retif:", {OpPlus, Retif, PuncColn})
...
TEST_CASE(Keyword, NextToPunc, 45, "+undef:", {OpPlus, Undef, PuncColn})
TEST_CASE(Keyword, NextToPunc, 46, "+null:", {OpPlus, Null, PuncColn})
