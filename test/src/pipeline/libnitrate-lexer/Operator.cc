...
///============================================================================///
/// ADJACENT OPERATORS
TEST_CASE(Operator, Adjacent, 0, "++", {OpInc, Token()});
TEST_CASE(Operator, Adjacent, 1, "--", {OpDec, Token()});
TEST_CASE(Operator, Adjacent, 2, "**", {OpTimes, OpTimes, Token()});
TEST_CASE(Operator, Adjacent, 3, "//", {Token(Note, ""), Token()});
TEST_CASE(Operator, Adjacent, 4, "%%", {OpPercent, OpPercent, Token()});
TEST_CASE(Operator, Adjacent, 5, "&&", {OpLogicAnd, Token()});
TEST_CASE(Operator, Adjacent, 6, "||", {OpLogicOr, Token()});
TEST_CASE(Operator, Adjacent, 7, "^^", {OpLogicXor, Token()});
TEST_CASE(Operator, Adjacent, 8, "~~", {OpBitNot, OpBitNot, Token()});
TEST_CASE(Operator, Adjacent, 9, "<<<<", {OpROTL, OpLT, Token()});
TEST_CASE(Operator, Adjacent, 10, ">>>>", {OpROTR, OpGT, Token()});
TEST_CASE(Operator, Adjacent, 12, "<<<<<<", {OpROTL, OpROTL, Token()});
TEST_CASE(Operator, Adjacent, 13, ">>>>>>", {OpROTR, OpROTR, Token()});
TEST_CASE(Operator, Adjacent, 14, "&&&&", {OpLogicAnd, OpLogicAnd, Token()});
TEST_CASE(Operator, Adjacent, 15, "||||", {OpLogicOr, OpLogicOr, Token()});
TEST_CASE(Operator, Adjacent, 16, "^^^^", {OpLogicXor, OpLogicXor, Token()});
TEST_CASE(Operator, Adjacent, 17, "!!", {OpLogicNot, OpLogicNot, Token()});
TEST_CASE(Operator, Adjacent, 18, "<<", {OpLShift, Token()});
TEST_CASE(Operator, Adjacent, 19, ">>", {OpRShift, Token()});
TEST_CASE(Operator, Adjacent, 20, "<=<=", {OpLE, OpLE, Token()});
TEST_CASE(Operator, Adjacent, 21, ">=>=", {OpGE, OpGE, Token()});
TEST_CASE(Operator, Adjacent, 22, "====", {OpEq, OpEq, Token()});
TEST_CASE(Operator, Adjacent, 23, "!=!=", {OpNE, OpNE, Token()});
TEST_CASE(Operator, Adjacent, 24, "==", {OpEq, Token()});
TEST_CASE(Operator, Adjacent, 25, "+=+=", {OpPlusSet, OpPlusSet, Token()});
TEST_CASE(Operator, Adjacent, 26, "-=-=", {OpMinusSet, OpMinusSet, Token()});
TEST_CASE(Operator, Adjacent, 27, "*=*=", {OpTimesSet, OpTimesSet, Token()});
TEST_CASE(Operator, Adjacent, 28, "/=/=", {OpSlashSet, OpSlashSet, Token()});
TEST_CASE(Operator, Adjacent, 29, "%=%=", {OpPercentSet, OpPercentSet, Token()});
TEST_CASE(Operator, Adjacent, 30, "&=&=", {OpBitAndSet, OpBitAndSet, Token()});
TEST_CASE(Operator, Adjacent, 31, "|=|=", {OpBitOrSet, OpBitOrSet, Token()});
TEST_CASE(Operator, Adjacent, 32, "^=^=", {OpBitXorSet, OpBitXorSet, Token()});
TEST_CASE(Operator, Adjacent, 33, "&&=&&=", {OpLogicAndSet, OpLogicAndSet, Token()});
TEST_CASE(Operator, Adjacent, 34, "||=||=", {OpLogicOrSet, OpLogicOrSet, Token()});
TEST_CASE(Operator, Adjacent, 35, "^^=^^=", {OpLogicXorSet, OpLogicXorSet, Token()});
TEST_CASE(Operator, Adjacent, 36, "<<=<<=", {OpLShiftSet, OpLShiftSet, Token()});
TEST_CASE(Operator, Adjacent, 37, ">>=>>=", {OpRShiftSet, OpRShiftSet, Token()});
TEST_CASE(Operator, Adjacent, 38, "<<<=<<<=", {OpROTLSet, OpROTLSet, Token()});
TEST_CASE(Operator, Adjacent, 39, ">>>=>>>=", {OpROTRSet, OpROTRSet, Token()});
TEST_CASE(Operator, Adjacent, 40, "++++", {OpInc, OpInc, Token()});
TEST_CASE(Operator, Adjacent, 41, "----", {OpDec, OpDec, Token()});
TEST_CASE(Operator, Adjacent, 42, "asas", {Token(Name, "asas"), Token()});
TEST_CASE(Operator, Adjacent, 43, "bitcast_asbitcast_as", {Token(Name, "bitcast_asbitcast_as"), Token()});
TEST_CASE(Operator, Adjacent, 44, "inin", {Token(Name, "inin"), Token()});
TEST_CASE(Operator, Adjacent, 45, "outout", {Token(Name, "outout"), Token()});
TEST_CASE(Operator, Adjacent, 46, "sizeofsizeof", {Token(Name, "sizeofsizeof"), Token()});
TEST_CASE(Operator, Adjacent, 47, "bitsizeofbitsizeof", {Token(Name, "bitsizeofbitsizeof"), Token()});
TEST_CASE(Operator, Adjacent, 48, "alignofalignof", {Token(Name, "alignofalignof"), Token()});
TEST_CASE(Operator, Adjacent, 49, "typeoftypeof", {Token(Name, "typeoftypeof"), Token()});
TEST_CASE(Operator, Adjacent, 50, "comptimecomptime", {Token(Name, "comptimecomptime"), Token()});
TEST_CASE(Operator, Adjacent, 51, "..", {OpRange, Token()});
TEST_CASE(Operator, Adjacent, 52, "....", {OpEllipsis, OpDot, Token()});
TEST_CASE(Operator, Adjacent, 53, "......", {OpEllipsis, OpEllipsis, Token()});
TEST_CASE(Operator, Adjacent, 54, "=>=>", {OpArrow, OpArrow, Token()});
TEST_CASE(Operator, Adjacent, 55, "??", {OpTernary, OpTernary, Token()});
