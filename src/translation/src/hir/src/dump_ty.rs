...
impl Dump for Type {
    ...
    fn dump_trunk(
        ...
        match self {
            ...
            Type::Array { element_type, len } => {
                write!(o, "[")?;
                ctx.store[element_type].dump_trunk(ctx, o)?;
                write!(o, "; {len}]")
            }
            ...
            Type::Struct(struct_type) => {
                ...
                for (i, (name, field_type)) in struct_type.fields.iter().enumerate() {
                    ...
                    write!(o, "{name}: ")?;
                    ctx.store[field_type].dump_trunk(ctx, o)?;
                }
                write!(o, " }}")
            }
            ...
            Type::Enum(enum_type) => {
                ...
                for (i, (name, variant_type)) in enum_type.variants.iter().enumerate() {
                    ...
                    write!(o, "{name}: ")?;
                    ctx.store[variant_type].dump_trunk(ctx, o)?;
                }
                write!(o, " }}")
            }
            ...
            Type::Function(func_type) => {
                ...
                for (i, param_type) in func_type.parameters.iter().enumerate() {
                    ...
                    ctx.store[param_type].dump_trunk(ctx, o)?;
                }
                write!(o, ") -> ")?;
                ctx.store[&func_type.return_type].dump_trunk(ctx, o)
            }
            ...
            Type::Reference(reference) => {
                ...
                ctx.store[&reference.to].dump_trunk(ctx, o)
            }
        }
    }
}
