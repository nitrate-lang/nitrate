...
pub use store::{
    BlockId, EnumAttributesId, EnumVariantsId, FunctionAttributesId, ItemId, PlaceId, Store,
...
pub mod prelude {
    pub use super::hir::*;
    pub use super::{
        BlockId, Dump, DumpContext, EnumAttributesId, EnumVariantsId, FunctionAttributesId, ItemId,
