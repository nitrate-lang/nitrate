...
fn mkfunc(
    ...
    FunctionId::from(Function {
        ...
        mangled_name: Some(NString::from(name)),
        generics: gens,
        params,
        return_type: rt,
        body,
...
fn resolve_func(body: Vec<BlockElement>, rt: TypeId, log: &CompilerLog, sym: &mut SymbolTab) -> Result<(), ()> {
    let mut f = Function {
        ...
        attributes: BTreeSet::new(),
        name: NString::from("f"),
        mangled_name: Some(NString::from("f")),
        generics: None,
        params: vec![],
        return_type: rt,
        body: Some(body),
...
fn test_effective_bounds_inferred() {
    store(|_| {
        ...
        let gv = nitrate_hir::GlobalVariable {
            ...
            is_mutable: false,
            name: NString::from("G"),
            mangled_name: Some(NString::from("G")),
            ty: i32t(),
            initializer: i32v(0),
        };
...
fn test_resolve_global() {
    store(|_| {
        ...
        let mut g = nitrate_hir::GlobalVariable {
            ...
            is_mutable: false,
            name: NString::from("C"),
            mangled_name: Some(NString::from("C")),
        ...
        let mut g2 = nitrate_hir::GlobalVariable {
            ...
            is_mutable: false,
            name: NString::from("M"),
            mangled_name: Some(NString::from("M")),
            ty: i32t(),
            initializer: i32v(99),
        };
        ...
        let mut g3 = nitrate_hir::GlobalVariable {
            ...
            is_mutable: false,
            name: NString::from("S"),
            mangled_name: Some(NString::from("S")),
            ty: unitt(),
...
fn test_resolve_global_initializer_with_inferred_type() {
    store(|_| {
        ...
        let mut g = nitrate_hir::GlobalVariable {
            ...
            is_mutable: false,
            name: NString::from("V"),
            mangled_name: Some(NString::from("V")),
            ty: TypeId::from(Type::Inferred {
                span: ByteSpan::default(),
                id: std::num::NonZeroU32::new(1).unwrap(),
                name: None,
