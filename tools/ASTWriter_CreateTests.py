...
if len(sys.argv) < 3:
    print("Usage: python ASTWriter_CreateTests.py <tree_dir> <output_dir>")
    sys.exit(1)
...
for subdir in glob.glob(os.path.join(tree_dir, "*")):
    ...
    unit_test_source_file = os.path.abspath(
        os.path.join(output_dir, f"ASTWriter_{domain}.gen.cc"))

    with open(unit_test_source_file, "w") as f:
        f.write("//=================================================//\n")
        f.write("// This file is automatically generated.           //\n")
        f.write("// Do not edit this file.                          //\n")
        f.write("// Generated by ASTWriter_CreateTests.py           //\n")
        ...
        f.write("static constexpr auto kFmt = ASTWriter::Format::JSON;\n\n")
...
[[maybe_unused]] static void TestCase(std::string_view source, std::string_view expect) {
  ...
  auto ast = GeneralParser(lexer, env, mm).Parse();
